...
# %%
# pop_vol_df["Sample"] = pop_vol_df["Growth Substrate"] + "_" + pop_vol_df["Time"].astype(str) + "_" + pop_vol_df["Rep"]
pop_vol_df["Sample"] = pop_vol_df["Growth Substrate"] + "_" + pop_vol_df["Rep"]
pop_vol_df.head()


# %%
mixed_anova2 = pg.mixed_anova(dv='Total', between='Growth Substrate', within='Time', subject='Sample', data=pop_vol_df)
# print(mixed_anova2)
...
# %%
df_anova.to_csv(analysis_dir + "dataframe_for_anova_table2.tsv", sep='\t')
...
# %%
anova21 = df_anova.anova(dv='Biomass', between=['Growth Substrate', 'Species'], ss_type=3)#.round(5)
anova21.to_csv(analysis_dir + "anova21.csv")
anova21


# %%
anova22 = df_anova.anova(dv='Biomass', between=['Growth Substrate', 'Time'], ss_type=3)#.round(5)
anova22.to_csv(analysis_dir + "anova22.csv")
anova22


# %%
anova23 = df_anova.anova(dv='Biomass', between=['Species', 'Time'], ss_type=3)#.round(5)
anova23.to_csv(analysis_dir + "anova23.csv")
anova23


# %%
# ancova_nutrient = df_anova.ancova(dv='Biomass', covar=["Time"], between='Growth Substrate')#.round(5)
# ancova_nutrient.to_csv(analysis_dir + "ancova_nutrient.csv")
# ancova_nutrient


# %%
# ancova_strain = df_anova.ancova(dv='Biomass', covar=["Time"], between='Species')#.round(5)
...
fig = px.scatter_ternary(df[pop_den_df["Rep"] == "rep1"], 
                         ...
                         size="Time", color="Growth Substrate")
...
fig = px.scatter_ternary(df, 
                         a='Variovorax', b='Sphingopyxis', c='Rhodococcus', 
                         size="Time", color="Growth Substrate", symbol="Rep")
fig.update_ternaries(aaxis_color="red", baxis_color="green", caxis_color="blue")
fig.show()
...
fig = px.scatter_ternary(df, 
                         a='Variovorax', b='Sphingopyxis', c='Rhodococcus', 
                         color="Time", symbol="Growth Substrate")
fig.update_ternaries(aaxis_color="red", baxis_color="green", caxis_color="blue")
fig.show()
...
# %%
pop_vol_1d_df = pd.DataFrame(pop_volumes_1d, columns = ["Rep", "Growth Substrate", "Time", "Variovorax", "Sphingopyxis", "Rhodococcus", "Radius", "Volume"])
...
delta_pop_vol_1d_df = pd.DataFrame(delta_pop_volumes_1d, columns = ["Rep", "Growth Substrate", "Time", "Variovorax", "Sphingopyxis", "Rhodococcus", "Radius", "Step", "Volume"])
delta_pop_vol_1d_df.to_pickle(analysis_dir + "spatial/delta_pop_vol_1d_df_" + str(slide_win) + ".pkl")


pop_den_1d_df = pd.DataFrame(pop_densities_1d, columns = ["Rep", "Growth Substrate", "Time", "Variovorax", "Sphingopyxis", "Rhodococcus", "Radius", "Volume"])
...
dft = df[(df["Growth Substrate"] == "Chitopentose") & (df["Time"] == 90) & (df["Rep"] == "rep2")].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66)].copy()
fig = px.line(dft, x='Radius', y=['Relative Volume'] 
              # , title='1D with Chitopentose at 90h'
              , color_discrete_sequence=["grey"]
              )
fig.update_layout(showlegend=False)
# plot the y limits between 0 and 1
fig.update_yaxes(range=[0, 1])

fig.write_image(analysis_dir + "spatial/relative_volume_1D_with_Chitopentose_at_90h_" + str(slide_win) + ".pdf")
fig.show()

# %%
df = pop_den_1d_df.copy()
dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3")].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66)].copy()
...
# %%
df = pop_den_1d_df.copy()
dft = df[(df["Growth Substrate"] == "Chitopentose") & (df["Time"] == 66) & (df["Rep"] == "rep3")].copy()
# dft = df[(df["Growth Substrate"] == "Chitopentose") & (df["Time"] == 66)].copy()
...
# %%
df = pop_den_1d_df.copy()
dft = df[(df["Growth Substrate"] == "Chitin") & (df["Time"] == 66) & (df["Rep"] == "rep3")].copy()
# dft = df[(df["Growth Substrate"] == "Chitin") & (df["Time"] == 66)].copy()
...
# %%
df = pop_den_1d_df.copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3")].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "Chitopentose") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "Chitin") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66)].copy()
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "Chitopentose") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
dft = df[(df["Growth Substrate"] == "Chitin") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Growth Substrate"] == "NAG")].copy()
...
# dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3")
#          & (df["Step"] == 10)
#          ].copy()
# # dft = df[(df["Growth Substrate"] == "NAG") & (df["Time"] == 66)].copy()
...
fig = px.scatter_ternary(df4plot,
                         a='Variovorax', b='Sphingopyxis', c='Rhodococcus', 
                         size="Time", color="Growth Substrate", symbol="Radius")
fig.update_ternaries(aaxis_color="red", baxis_color="green", caxis_color="blue")
fig.show()
...
for time in times:
    for rep in ["rep" + str(i+1) for i in range(3)]:
        ...
        for carbon in ["NAG", "Chitopentose", "Chitin"]:
            dft = dfr[(dfr["Growth Substrate"] == carbon)].copy()
            fig = px.line(dft, x='Radius', y=['Variovorax', 'Sphingopyxis', 'Rhodococcus', 'Relative Volume'], title="Relative abundance of " + rep + " with " + carbon + " at " + str(time) + "h", color_discrete_map=color_map, template="ggplot2")
            # fig.show()
            fig.write_image(analysis_dir + "spatial/exploratory/rel_abund_" + rep +"_with_" + carbon + "_at_" + str(time) + "h_" + str(slide_win) + ".pdf", scale=1, width=1000, height=500)
...
for time in times:
    for rep in ["rep" + str(i+1) for i in range(3)]:
        ...
        for carbon in ["NAG", "Chitopentose", "Chitin"]:
            dft = dfr[(dfr["Growth Substrate"] == carbon)].copy()
            fig = px.line(dft, x='Radius', y=['Relative Volume'], title="Relative volume of " + rep + " with " + carbon + " at " + str(time) + "h", color_discrete_map=color_map, template="ggplot2")
            # fig.show()
            fig.write_image(analysis_dir + "spatial/exploratory/rel_vol_" + rep +"_with_" + carbon + "_at_" + str(time) + "h_" + str(slide_win) + ".pdf", scale=1, width=1000, height=500)
...
for carbon in ["NAG", "Chitopentose", "Chitin"]:
    for rep in ["rep" + str(i+1) for i in range(3)]:
        dfr = df[(df["Growth Substrate"] == carbon) & (df["Rep"] == rep)].copy()
        ymax = dfr[['Variovorax', 'Sphingopyxis', 'Rhodococcus']].values.flatten().max()
        for time in times:
            ...
            fig = px.line(dft, x='Radius', y=['Variovorax', 'Sphingopyxis', 'Rhodococcus'], title="Biomass abundance of " + rep + " with " + carbon + " at " + str(time) + "h", color_discrete_map=color_map, template="ggplot2")
            fig.update_layout(yaxis_range=[0,ymax])
            # fig.show()
            fig.write_image(analysis_dir + "spatial/exploratory/biomass_abund_" + rep +"_with_" + carbon + "_at_" + str(time) + "h_" + str(slide_win) + ".pdf", scale=1, width=1000, height=500)
...
for time in times:
    for rep in ["rep" + str(i+1) for i in range(3)]:
        ...
        for carbon in ["NAG", "Chitopentose", "Chitin"]:
            ...
            fig = px.line(dft, x='Radius', y=['Variovorax / Volume', 'Sphingopyxis / Volume', 'Rhodococcus/ Volume', 'Relative Volume'], title="Biomass density of " + rep + " with " + carbon + " at " + str(time) + "h", color_discrete_map=color_map, template="ggplot2")
            # fig.show()
            fig.write_image(analysis_dir + "spatial/exploratory/biomass_density_vol_" + rep +"_with_" + carbon + "_at_" + str(time) + "h_" + str(slide_win) + ".pdf", scale=1, width=1000, height=500)
...
# %%
sns.lineplot(data=pop_vol, x="Time", y="Total", hue="Growth Substrate")
plt.savefig(analysis_dir + "lineplot_total_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Variovorax", hue="Growth Substrate")
plt.savefig(analysis_dir + "lineplot_Vp_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Sphingopyxis", hue="Growth Substrate")
plt.savefig(analysis_dir + "lineplot_Sf_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Rhodococcus", hue="Growth Substrate")
...
# %%
sns.lineplot(data=pop_vol, x="Time", y="Total", hue="Growth Substrate", err_style="bars", ci=66.7)
plt.ylim(0, 8e7)
plt.savefig(analysis_dir + "lineplot_bar_total_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Variovorax", hue="Growth Substrate", err_style="bars", ci=66.7)
plt.ylim(0, 5e7)
plt.savefig(analysis_dir + "lineplot_bar_Vp_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Sphingopyxis", hue="Growth Substrate", err_style="bars", ci=66.7)
plt.ylim(0, 5e7)
plt.savefig(analysis_dir + "lineplot_bar_Sf_volume.pdf", bbox_inches='tight', dpi=300)
plt.show()
plt.close()
sns.lineplot(data=pop_vol, x="Time", y="Rhodococcus", hue="Growth Substrate", err_style="bars", ci=66.7)
plt.ylim(0, 5e7)
...
# %%
sns.boxplot(data=pop_vol, x="Time", y="Total", hue="Growth Substrate")
# plt.show()
plt.savefig(analysis_dir + "boxplot_total_volume.pdf", bbox_inches='tight', dpi=300)
plt.close()
sns.boxplot(data=pop_vol, x="Time", y="Variovorax", hue="Growth Substrate")
plt.savefig(analysis_dir + "boxplot_Vp_volume.pdf", bbox_inches='tight', dpi=300)
plt.close()
sns.boxplot(data=pop_vol, x="Time", y="Sphingopyxis", hue="Growth Substrate")
plt.savefig(analysis_dir + "boxplot_Sf_volume.pdf", bbox_inches='tight', dpi=300)
plt.close()
sns.boxplot(data=pop_vol, x="Time", y="Rhodococcus", hue="Growth Substrate")
...
# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Growth Substrate"] == "NAG")]
...
# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Growth Substrate"] == "Chitopentose")]
# ax = sns.boxplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
# plt.ylim(0, 1.1e8)
# plt.legend([],[], frameon=False)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
...
# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Growth Substrate"] == "Chitin")]
# ax = sns.boxplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
# plt.ylim(0, 1.1e8)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
# annotator.configure(test='Mann-Whitney', text_format='star', loc='outside')
...
df = pop_vol_melted[(pop_vol_melted["Growth Substrate"] == "NAG")]
...
df = pop_vol_melted[(pop_vol_melted["Growth Substrate"] == "Chitopentose")]
...
df = pop_vol_melted[(pop_vol_melted["Growth Substrate"] == "Chitin")]
...
df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Growth Substrate"] == "NAG")]
ax = sns.lineplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
plt.ylim(0, 1.1e8)
plt.legend([],[], frameon=False)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
# annotator.configure(test='Mann-Whitney', text_format='star', loc='outside')
...
df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Growth Substrate"] == "NAG")]
ax = sns.lineplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map, err_style="bars", ci=66.7)
plt.ylim(0, 8e7)
plt.legend([],[], frameon=False)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
# annotator.configure(test='Mann-Whitney', text_format='star', loc='outside')
...
# %%
df = pop_vol_1d_df.copy()
df = df[['Time', 'Growth Substrate', 'Variovorax / Volume', 'Sphingopyxis / Volume', 'Rhodococcus/ Volume', 'Relative Volume', 'Radius']].copy()
df = df[(df["Time"] >22) & (df["Radius"] % (25 * pixel_size) == 0)]
# color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue'}
# sns.scatterplot(data=df, y="Variovorax / Volume", x="Relative Volume", hue="Growth Substrate")
sns.scatterplot(data=df, y="Sphingopyxis / Volume", x="Relative Volume", hue="Growth Substrate")
# sns.scatterplot(data=df, y="Rhodococcus/ Volume", x="Relative Volume", hue="Growth Substrate")
plt.show()


# %%
df.loc[df["Relative Volume"] < 0.4, "Habitat size"] 
...
# sns.scatterplot(data=df, y="Variovorax", x="Relative Volume", hue="Growth Substrate")
sns.scatterplot(data=df, y="Sphingopyxis", x="Volume", hue="Growth Substrate")
# sns.scatterplot(data=df, y="Rhodococcus", x="Relative Volume", hue="Growth Substrate")

# sns.scatterplot(data=df, y="dv_dvol", x="ds_dvol", hue="Growth Substrate")
...
# df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Total", "Variovorax", "Sphingopyxis", "Rhodococcus"], var_name="Strain", value_name="Biomass")
# color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue', 'Total': 'grey'}
df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Variovorax", "Sphingopyxis", "Rhodococcus"], var_name="Strain", value_name="Biomass")
color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue'}
# df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Variovorax / Volume", "Sphingopyxis / Volume", "Rhodococcus/ Volume"], var_name="Strain", value_name="Biomass / Habitat size")
...
# sns.boxplot(data=df4plot[df4plot["Time"] == 90 & (df4plot["Growth Substrate"] == "NAG")], x="Habitat size", y="Biomass", hue="Strain", palette=color_map, showfliers = False)
# sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "NAG")], x="Habitat size", y="Biomass", hue="Strain", palette=color_map, showfliers = False)
sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "Chitopentose")], x="Habitat size", y="Biomass", hue="Strain", palette=color_map, showfliers = False)
# sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "Chitin")], x="Habitat size", y="Biomass", hue="Strain", palette=color_map, showfliers = False)
# plt.ylim(1, 1.5e4)
# plt.yscale("log")
...
# %%
df = pop_vol_1d_df[pop_vol_1d_df["Rep"] == "rep2"].copy()
df["Habitat Size"] = ""
...
# %%
anova4 = df4plot.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_time_all_rep2.csv")
anova4
...
# %%
df4anova = df4plot[(df4plot["Relative Volume"] >= 0.8) | (df4plot["Relative Volume"] < 0.4)].copy()
df4anova2 = df4anova[(df4anova["Time"] == 11) | (df4anova["Time"] == 37) | (df4anova["Time"] == 90)].copy()
df4anova3 = df4anova[(df4anova["Time"] == 90)].copy()
df4anova3

# %%
df4anova["Habitat Size"].value_counts()

# %%
df4anova.to_csv(analysis_dir + "dataframe_for_anova_table3.tsv", sep='\t')

# %%
import statsmodels.regression.mixed_linear_model as smf 
data = df4anova
model = smf.MixedLM.from_formula(
    'Biomass ~ Time * Q("Growth Substrate") + Q("Growth Substrate") * Q("Habitat Size")',
    data=data,
    groups="Radius"
)
result = model.fit() 
...
# %%
selected = []
for growth_substrate in ["NAG", "Chitopentose", "Chitin"]:
    for species in ["Variovorax", "Sphingopyxis", "Rhodococcus"]:
        for time in [0, 11, 37, 66, 90]:
            for habitat_size in ["(0.0~0.4)", "(0.8~1.0)"]:
                # select the largest or smallest habitat size only
                if habitat_size == "(0.0~0.4)":
                    selected.append(df4anova[df4anova["Growth Substrate"] == growth_substrate][df4anova["Species"] == species][df4anova["Habitat Size"] == habitat_size][df4anova["Time"] == time].nsmallest(3, "Relative Volume"))
                else:
                    selected.append(df4anova[df4anova["Growth Substrate"] == growth_substrate][df4anova["Species"] == species][df4anova["Habitat Size"] == habitat_size][df4anova["Time"] == time].nlargest(3, "Relative Volume"))

df_selected = pd.concat(selected)
df_selected

# %%
df_selected.to_csv(analysis_dir + "dataframe_for_anova_table3_selected.tsv", sep='\t')

# %%
anova4 = df4plot.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_time_all.csv")
anova4


# %%
anova4 = df4anova.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Time", "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_with_only_pore_throut_and_pore_body.csv")
anova4


# %%
anova4 = df4anova.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_with_only_pore_throut_and_pore_body_time_all.csv")
anova4
...
# %%
anova4 = df4anova2.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_with_only_pore_throut_and_pore_body_time_11_37_90.csv")
anova4


# %%
anova4 = df4anova3.anova(dv='Biomass', between=['Growth Substrate', 'Species', "Habitat Size"], ss_type=3).round(4)
anova4.to_csv(analysis_dir + "anova4_with_only_pore_throut_and_pore_body_time_90.csv")
anova4
...
for time in [11, 37, 90]:
    for carbon in ["NAG", "Chitopentose", "Chitin"]:
        ...
        annotator.configure(test="Mann-Whitney").apply_and_annotate()
        plt.legend([],[], frameon=False)
        plt.savefig(analysis_dir + "relative_abundance_vs_habitate_size_" + carbon + "_at_" + str(time) + "_selective.pdf", bbox_inches='tight', dpi=300)
        plt.close()
...
g.add_legend()
plt.savefig(analysis_dir + "relative_abundance_vs_habitate_size_all.pdf", bbox_inches='tight', dpi=300)
...
# Colors: Light/Dark pairs for each species
# Variovorax (Red), Sphingopyxis (Green), Rhodococcus (Blue)
# Colors are: [Species1-Hue1, Species1-Hue2, Species2-Hue1, Species2-Hue2, ...]
# box_colors = [
#     "#ffcccc", "#cc0000",  # Variovorax: Throat (Light), Body (Dark) -- Red
#     "#ccffcc", "#008000",  # Sphingopyxis: Throat (Light), Body (Dark) -- Green
#     "#ccccff", "#0000cc"   # Rhodococcus: Throat (Light), Body (Dark) -- Blue
# ]
box_colors = [
    "#ffcccc", "#ccffcc", "#ccccff",   # Variovorax: Throat (Light), Body (Dark) -- Red
    "#cc0000", "#008000", "#0000cc" # Sphingopyxis: Throat (Light), Body (Dark) -- Green
    # Rhodococcus: Throat (Light), Body (Dark) -- Blue
]
...
def compute_mean_sd_stats(values):
    """Compute boxplot stats using mean±SD instead of median/quartiles.
    Box = mean ± 1 SD, whiskers = mean ± 2 SD, center line = mean."""
...
def mean_sd_boxplot(data, x, y, hue=None, order=None, hue_order=None,
                    showfliers=False, ax=None):
    """Draw boxplot with mean±SD (box=mean±1SD, whiskers=mean±2SD)."""
    if ax is None:
        ax = plt.gca()
    if order is None:
    ...
    for i, xval in enumerate(order):
        for j, hval in enumerate(hue_order):
            if has_hue:
                subset = data.loc[(data[x] == xval) & (data[hue] == hval), y].dropna().values
            else:
                subset = data.loc[data[x] == xval, y].dropna().values

            if len(subset) > 0:
                stats = compute_mean_sd_stats(subset)
            else:
                stats = {'med': 0, 'q1': 0, 'q3': 0, 'whislo': 0, 'whishi': 0, 'fliers': [], 'mean': 0}

            all_stats.append(stats)
            positions.append(i + (j - (n_hue - 1) / 2) * width)

    bp = ax.bxp(all_stats, positions=positions, widths=width * 0.8,
                patch_artist=True, showfliers=showfliers)

    # Color per hue level using default seaborn colors
    palette = sns.color_palette()
    for idx, patch in enumerate(bp['boxes']):
        hue_idx = idx % n_hue
        patch.set_facecolor(palette[hue_idx])
        patch.set_alpha(0.7)
...
for time in [11, 37, 90]:
    for carbon in ["NAG", "Chitopentose", "Chitin"]:
        ...
        ax, bp = mean_sd_boxplot(data=df4plot2, 
                        x="Species", 
                        y="Relative abundance", 
                        hue="Habitat Size", 
                        showfliers=False, 
...
def colored_boxplot(data, **kwargs):
    ax = plt.gca()
    ax, bp = mean_sd_boxplot(data=data, x="Species", y="Relative abundance", hue="Habitat Size",
                             order=species_order, hue_order=hue_order, showfliers=False, ax=ax)
    for i, box in enumerate(bp['boxes']):
        if i < len(box_colors):
            box.set_facecolor(box_colors[i])
...
# df.loc[df["Relative Volume"] > 0.9, "Habitat size"] = "[0.9,1.0)"
# df.loc[df["Relative Volume"] > 0.8, "Habitat size"] = "[0.8,1.0]"
# df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Total", "Variovorax", "Sphingopyxis", "Rhodococcus"], var_name="Species", value_name="Density")
# color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue', 'Total': 'grey'}
df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Variovorax", "Sphingopyxis", "Rhodococcus"], var_name="Species", value_name="Density")
color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue'}
# df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat size", "Radius", "Relative Volume"], value_vars=["Variovorax / Volume", "Sphingopyxis / Volume", "Rhodococcus/ Volume"], var_name="Species", value_name="Density / Habitat size")
# color_map = {'Variovorax / Volume': 'red', 'Sphingopyxis / Volume': 'green', 'Rhodococcus/ Volume': 'blue'}

df4plot = df4plot.loc[(df4plot["Density"] > 0)].copy()
# df4plot = df4plot.loc[df4plot["Time"] == 37]
# sns.boxplot(data=df4plot[df4plot["Time"] == 90 & (df4plot["Growth Substrate"] == "NAG")], x="Habitat size", y="Density", hue="Species", palette=color_map, showfliers = False)
# sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "NAG")], x="Habitat size", y="Density", hue="Species", palette=color_map, showfliers = False)
# sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "Chitopentose")], x="Habitat size", y="Density", hue="Species", palette=color_map, showfliers = False)
# sns.boxplot(data=df4plot[(df4plot["Growth Substrate"] == "Chitin")], x="Habitat size", y="Density", hue="Species", palette=color_map, showfliers = False)
# plt.ylim(1, 1.5e4)
# plt.yscale("log")
...
df4plot = pd.melt(df, id_vars=["Time", "Growth Substrate", "Habitat position", "Radius", "Relative Volume"], value_vars=["Variovorax", "Sphingopyxis", "Rhodococcus"], var_name="Species", value_name="Biomass")
color_map = {'Variovorax': 'red', 'Sphingopyxis': 'green', 'Rhodococcus': 'blue'}
...
for time in [11, 37, 90]:
    for carbon in ["NAG", "Chitopentose", "Chitin"]:
        df4plot2 = df4plot.loc[(df4plot["Time"] == time) & (df4plot["Growth Substrate"] == carbon)]
